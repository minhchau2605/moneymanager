...
import com.example.moneymanager.ThongKe.CaiDat;
import com.example.moneymanager.ThongKe.CaiDatAdapter;
...
public class CaiDatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llist=db.getALLS("");
        final CaiDatAdapter arrayAdapter1=new CaiDatAdapter(getParent(),R.layout.custom_tong,llist);
            ...
            public void onClick(View v) {
                ...
                if (editText.getText().toString().length() > 0) {
                    ...
                    if (db.kiemtra(spinthuchi, editText.getText().toString()) == true) {
                        ...
                        finish();
                        /*llist.clear();
                        llist.addAll(db.getALLS(""));
                        arrayAdapter1.notifyDataSetChanged();
                        listView.setSelection(arrayAdapter1.getCount()-1);*/
                        db.close();
                    } else {
